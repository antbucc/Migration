...
<model ref="r:8f31922a-cdc8-4518-9910-4625404b48d9(Deployment.structure)">
  ...
  <node concept="1TIwiD" id="1qDekGLZ6bR">
    <property role="EcuMT" value="1632899335022469879" />
    <property role="TrG5h" value="DockerImage" />
    <property role="34LRSv" value="dockerImage" />
    <property role="19KtqR" value="true" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="PrWs8" id="1qDekGLZ6nA" role="PzmwI">
      <ref role="PrY4T" to="tpck:h0TrEE$" resolve="INamedConcept" />
    </node>
    <node concept="1TJgyi" id="1qDekGLZ6GJ" role="1TKVEl">
      <property role="IQ2nx" value="1632899335022471983" />
      <property role="TrG5h" value="From" />
      <ref role="AX2Wp" to="tpck:fKAOsGN" resolve="string" />
    </node>
    <node concept="1TJgyi" id="1qDekGLZ76$" role="1TKVEl">
      <property role="IQ2nx" value="1632899335022473636" />
      <property role="TrG5h" value="Maintainer" />
      <ref role="AX2Wp" to="tpck:fKAOsGN" resolve="string" />
    </node>
    <node concept="1TJgyi" id="1qDekGLZ7kH" role="1TKVEl">
      <property role="IQ2nx" value="1632899335022474541" />
