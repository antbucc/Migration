...
<model ref="r:a49f5bd5-da6c-4e69-98f3-07b1a5eaa6b2(Microservice.editor)">
  ...
  <node concept="24kQdi" id="1vRkFORW_G4">
    ...
    <node concept="3EZMnI" id="1qDekGLSdXC" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="17z$LoBcKv9" role="3EZMnx">
        <property role="3F0ifm" value=" " />
        <node concept="pVoyu" id="17z$LoBcKAy" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F2HdR" id="17z$LoBdkZV" role="3EZMnx">
        <ref role="1NtTu8" to="hbv9:1qDekGMjesM" resolve="behavior" />
        <node concept="l2Vlx" id="17z$LoBdkZY" role="2czzBx" />
      </node>
  ...
  <node concept="24kQdi" id="1qDekGMbYBz">
    ...
    <node concept="3EZMnI" id="1qDekGMbYPK" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="17z$LoBco4K" role="3EZMnx">
        <property role="3F0ifm" value=" " />
        <node concept="ljvvj" id="17z$LoBco6s" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F0ifn" id="17z$LoBco6N" role="3EZMnx">
        <property role="3F0ifm" value="Location" />
        <node concept="lj46D" id="17z$LoBco7V" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F0ifn" id="17z$LoBco8k" role="3EZMnx">
        <property role="3F0ifm" value=":" />
      </node>
      <node concept="3F0A7n" id="17z$LoBco94" role="3EZMnx">
        <ref role="1NtTu8" to="hbv9:17z$LoBco4q" resolve="Location" />
      </node>
  ...
  <node concept="24kQdi" id="62GV8nSiR0Y">
    <ref role="1XX52x" to="hbv9:1vRkFORXv4X" resolve="ResponseType" />
    <node concept="3EZMnI" id="62GV8nSiR34" role="2wV5jI">
      <node concept="l2Vlx" id="62GV8nSiR35" role="2iSdaV" />
      <node concept="3F0ifn" id="62GV8nSiR36" role="3EZMnx">
        <property role="3F0ifm" value="response type" />
      </node>
      <node concept="3F0A7n" id="62GV8nSiR37" role="3EZMnx">
        <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
      </node>
      <node concept="3F0ifn" id="62GV8nSiR38" role="3EZMnx">
        <property role="3F0ifm" value=";" />
        <node concept="11L4FC" id="62GV8nSiR39" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
    </node>
