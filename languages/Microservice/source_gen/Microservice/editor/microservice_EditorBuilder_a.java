...
/*package*/ class microservice_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new microservice_EditorBuilder_a.inputPortSingleRoleHandler_1piost_g3a(myNode, MetaAdapterFactory.getContainmentLink(0x77de623ba0547edL, 0xa860a4445e8de4c1L, 0x17f752bd37f231e4L, 0x16a9394b31df9c66L, "inputPort"), getEditorContext());
    return provider.createCell();
  }
  private static class inputPortSingleRoleHandler_1piost_g3a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public inputPortSingleRoleHandler_1piost_g3a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new microservice_EditorBuilder_a.outputPortSingleRoleHandler_1piost_k3a(myNode, MetaAdapterFactory.getContainmentLink(0x77de623ba0547edL, 0xa860a4445e8de4c1L, 0x17f752bd37f231e4L, 0x16a9394b31df9ff1L, "outputPort"), getEditorContext());
    return provider.createCell();
  }
  private static class outputPortSingleRoleHandler_1piost_k3a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public outputPortSingleRoleHandler_1piost_k3a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new microservice_EditorBuilder_a.mainSingleRoleHandler_1piost_o3a(myNode, MetaAdapterFactory.getContainmentLink(0x77de623ba0547edL, 0xa860a4445e8de4c1L, 0x17f752bd37f231e4L, 0x16a9394b31dfae14L, "main"), getEditorContext());
    return provider.createCell();
  }
  private static class mainSingleRoleHandler_1piost_o3a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public mainSingleRoleHandler_1piost_o3a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), MetaAdapterFactory.getContainmentLink(0x77de623ba0547edL, 0xa860a4445e8de4c1L, 0x17f752bd37f231e4L, 0x16a9394b31dfae14L, "main"), child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), MetaAdapterFactory.getContainmentLink(0x77de623ba0547edL, 0xa860a4445e8de4c1L, 0x17f752bd37f231e4L, 0x16a9394b31dfae14L, "main"), child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(MetaAdapterFactory.getContainmentLink(0x77de623ba0547edL, 0xa860a4445e8de4c1L, 0x17f752bd37f231e4L, 0x16a9394b31dfae14L, "main"));
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
      style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), MetaAdapterFactory.getContainmentLink(0x77de623ba0547edL, 0xa860a4445e8de4c1L, 0x17f752bd37f231e4L, 0x16a9394b31dfae14L, "main")));
      try {
        EditorCell editorCell = super.createEmptyCell();
